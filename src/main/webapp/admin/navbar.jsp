...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<div class="col-md-3">
		 <a href="login.jsp" class="btn btn-success"><i class="fa-regular fa-user"></i>Admin</a>
		 
		 <a href="../logout"class="btn btn-danger text-white"><i class="fa-solid fa-arrow-right-from-bracket"></i>Logout</a>
		 </div>
	</div>
</div>
